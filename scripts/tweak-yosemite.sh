...
# This slightly modified from: https://gist.github.com/brandonb927/3195465
...
echo ""
echo "Requiring password --immediately-- a bit after sleep or screen saver begins"
...
echo ""
echo "Set Dock to auto-hide and tweak the auto-hiding delay? (y/n)"
read -r response
case $response in
  [yY])
